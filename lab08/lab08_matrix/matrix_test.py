...
def test_wk4_documentation():
  ...
  m3 = Matrix(2, 2)
  m3[0,0] = 1 # m3.set((0,0), 1)
  m3[0,1] = 3 # m3.set((0,1), 3)
  m3[1,0] = 4 # m3.set((1,0), 4)
  m3[1,1] = 5 # m3.set((1,1), 5)
  assert str(m3) == '1 3\n4 5'
...
def test_multiply_4x2():
    m7 = Matrix(2,3)
    m7[0,0] = 2 # m7.set((0,0), 2)
    m7[0,1] = 1 # m7.set((0,1), 1)
    m7[0,2] = 4 # m7.set((0,2), 4)
    m7[1,0] = 0 # m7.set((1,0),0)
    m7[1,1] = 1 # m7.set((1,1),1)
    m7[1,2] = 1 # m7.set((1,2),1)

    m8 = Matrix(3,4)
    m8[0,0] = 6 # m8.set((0,0), 6)
    m8[0,1] = 3 # m8.set((0,1), 3)
    m8[0,2] = -1 # m8.set((0,2), -1)
    m8[1,0] = 1 # m8.set((1,0), 1)
    m8[1,1] = 1 # m8.set((1,1), 1)
    m8[1,3] = 4 # m8.set((1,3), 4)
    m8[2,0] = -2 # m8.set((2,0), -2)
    m8[2,1] = 5 # m8.set((2,1), 5)
    m8[2,3] = 2 # m8.set((2,3), 2)
...
def test_side_effects():
    m = Matrix(2, 2)
    m[0,0] = 7 # m1.set((0,0), 7)
    m[0,1] = 2 # m1.set((0,1), 2)
    m[1,0] = 3 # m1.set((1,0), 3)
    m[1,1] = 99
    cpy1 = m[1,...]
    cpy2 = m[...,1]
